...
call cl.exe /nologo /W2 /WX /EHa- /GS- /GR- /Od /Zi /FS /DSERVER /I %BASELIB%  /I %LIBDIR% /Fd"servercode_%unique%.pdb" /Feservercode.dll %FILES%  /MTd /link /INCREMENTAL:NO /NODEFAULTLIB /DLL %LIBS% /PDB:"servercode_%unique%.pdb"
